...
class RadioSimulatorApp(ctk.CTk):
    ...
    def update_radio_logic(self, is_init=False):
        ...
        # ===== REAL SINE WAVE =====
        frequency = max(1, self.freq_val)
        amplitude = (self.power_val + 60) / 60
